...
function guessLeagueFromTeams(teams) {
  ...
  if (/(salavat yulaev|ak bars|akbars|metallurg magnitogorsk|magnitogorsk|nizhnekamsk|avangard omsk|avangard|cska moscow|cska|dynamo moscow|dynamo msk|locomotiv|torpedo nn|kunlun|severstal|admiral|amur|khabarovsk|avtomobilist|avangard|barys|traktor|shanghai dragons|sibir|sochi|spartak|yunost|red star|kunlun|sk a|ska|hc sochi|hc spartak|amur khabarovsk|tambov|metallurg|niznekamsk|dinamo minsk|minsk|yekaterinburg|avtomobilist|hc torpedo|hc lokomotiv|hc dinamo|hc bars|sk a saint|ska saint|kunlun red star|hc admiral|hc amur|vladivostok|cherepovets|adler|sibir novosibirsk|tver|togliatti|hc vladivostok|hc admiral vladivostok|neftekhimik|hc neftekhimik|hc chimik|hc cska|hc sochi|hc spartak|hc dynamo msk|hc lokomotiv yaroslavl|hc torpedo nn)/i.test(joined)) return 'KHL';
