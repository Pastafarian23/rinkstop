// scripts/load-secrets.cjs — CommonJS version for .js scripts
// Mirror of load-secrets.mjs for scripts that use require().
// Top-level sync (no await). Run automatically on require.
//
// Usage:
//   require('./load-secrets.cjs');  // must be FIRST in the file
