...
export const FEDERATIONS: Federation[] = [
  ...
  },
  {
    ...
    federationUrl: 'https://www.ihuk.co.uk',
    governingBody: 'IIHF (IHL/IHA)',
    safeguardingBody: 'UK Ice Hockey Safeguarding Trust',
    safeguardingUrl: 'https://www.ihuk.co.uk/safeguarding',
    requiredDocKinds: [
  ...
  },
  {
    ...
    federationName: 'Český hokej (Český svaz ledního hokeje — ČSLH)',
    federationUrl: 'https://www.cslh.cz',
    governingBody: 'IIHF',
  ...
  },
  {
    ...
    federationName: 'Nederlandse IJshockey Associatie (NIJA)',
    federationUrl: 'https://www.nija.nl',
    governingBody: 'IIHF',
  ...
  },
  {
    countryCode: 'BE',
    countryName: 'Belgium',
    federationName: 'Belgische IJshockey Federatie (BIJF)',
  ...
  },
  {
    countryCode: 'ES',
    countryName: 'Spain',
    federationName: 'Real Federación Española de Hockey hielo (RFEOH)',
    federationUrl: 'https://www.rfeh.es',
    governingBody: 'IIHF',
  ...
  },
  {
    ...
    federationName: 'Lietuvos ledo ritulio federacija (LLRF)',
    federationUrl: 'https://www.ihockey.lt',
    governingBody: 'IIHF',
  ...
  },
  {
    countryCode: 'EE',
    countryName: 'Estonia',
    federationName: 'Eesti Jäähokiliit (EJHL)',
    federationUrl: 'https://www.ejhl.ee',
    governingBody: 'IIHF',
  ...
  },
  {
    countryCode: 'HU',
    countryName: 'Hungary',
    federationName: 'Magyar Jégkorong Szövetség (MJSz)',
    federationUrl: 'https://www.icehockey.hu',
    governingBody: 'IIHF',
    safeguardingBody: 'MJSz — Gyermekvédelem',
  ...
  },
  {
    ...
    federationName: 'New Zealand Ice Hockey Federation (NZIHF)',
    federationUrl: 'https://www.nzicehockey.co.nz',
    governingBody: 'IIHF',
  ...
  },
  {
    ...
    federationName: 'Cebu Ice Hockey Association / Philippine Ice Hockey Federation',
    federationUrl: 'https://www.facebook.com/cebicehockey',
    governingBody: 'IIHF (Associate Member)',
    ...
    requiredDocKinds: [
      ...
      { kind: 'transfer', label: 'Transfer Certificate', note: 'Required for international transfers via IIHF' },
      { kind: 'registration', label: 'National Sports Federation Registration', note: 'Registered with PSC or relevant sports body' },
    ...
    ageGroupNote: 'Emerging hockey nation; IIHF associate member. Categories follow IIHF guidelines; operates youth and senior programs with limited rinks.',
  },
];
