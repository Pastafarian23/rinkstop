...
>>>>>>> Stashed changes
            ...
            mainEntityOfPage: `https://rinkstop.com/blog/${post.slug}`,
          }),
        }}
      />
          ...
          >
            ...
            <div>
              ...
              <div style={{
                ...
                <a
                  href={`https://twitter.com/intent/tweet?text=${encodeURIComponent(post.title)}&url=https://rinkstop.com/blog/${post.slug}`}
                  target="_blank"
