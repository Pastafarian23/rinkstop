  ...
  return (
    <main style={{ maxWidth: '900px', margin: '0 auto', padding: '2rem 1rem 4rem' }}>
      <nav style={{ fontSize: '0.75rem', color: 'rgba(255,255,255,0.4)', marginBottom: '1.5rem' }}>
        ...
        <span style={{ margin: '0 0 0.4rem' }}>›</span>
        <span style={{ color: 'rgba(255,255,255,0.6)' }}>How Hockey Development Works</span>
      </nav>
      ...
      <div style={{ color: 'rgba(255,255,255,0.75)', lineHeight: 1.8, fontSize: '1rem' }}>
        <h2 style={{ fontFamily: '"Bebas Neue", sans-serif', fontSize: '1.5rem', color: '#fff', letterSpacing: '0.04em', marginTop: '2.5rem', marginBottom: '1rem' }}>The pathway at a glance</h2>
        ...
        <h2 style={{ fontFamily: '"Bebas Neue", sans-serif', fontSize: '1.5rem', color: '#fff', letterSpacing: '0.04em', marginTop: '2.5rem', marginBottom: '1rem' }}>Ages 3–8: Learn-to-skate and learn-to-play</h2>
        <p style={{ marginBottom: '1rem' }}>
        ...
        <h2 style={{ fontFamily: '"Bebas Neue", sans-serif', fontSize: '1.5rem', color: '#fff', letterSpacing: '0.04em', marginTop: '2.5rem', marginBottom: '1rem' }}>Ages 8–14: House league and travel</h2>
        <p style={{ marginBottom: '1rem' }}>
        ...
        <h2 style={{ fontFamily: '"Bebas Neue", sans-serif', fontSize: '1.5rem', color: '#fff', letterSpacing: '0.04em', marginTop: '2.5rem', marginBottom: '1rem' }}>Ages 14–18: High school, junior, and the decision point</h2>
        <p style={{ marginBottom: '1rem' }}>
        ...
        <h2 style={{ fontFamily: '"Bebas Neue", sans-serif', fontSize: '1.5rem', color: '#fff', letterSpacing: '0.04em', marginTop: '2.5rem', marginBottom: '1rem' }}>Ages 18–22: NCAA hockey</h2>
        <p style={{ marginBottom: '1rem' }}>
        ...
        <h2 style={{ fontFamily: '"Bebas Neue", sans-serif', fontSize: '1.5rem', color: '#fff', letterSpacing: '0.04em', marginTop: '2.5rem', marginBottom: '1rem' }}>After college: Minor pro and the rest</h2>
        <p style={{ marginBottom: '1rem' }}>
        ...
        <h2 style={{ fontFamily: '"Bebas Neue", sans-serif', fontSize: '1.5rem', color: '#fff', letterSpacing: '0.04em', marginTop: '2.5rem', marginBottom: '1rem' }}>Specialization and burnout</h2>
        <p style={{ marginBottom: '1rem' }}>
        ...
        <h2 style={{ fontFamily: '"Bebas Neue", sans-serif', fontSize: '1.5rem', color: '#fff', letterSpacing: '0.04em', marginTop: '2.5rem', marginBottom: '1rem' }}>Off-ice development</h2>
        <p style={{ marginBottom: '1rem' }}>
        ...
        <h2 style={{ fontFamily: '"Bebas Neue", sans-serif', fontSize: '1.5rem', color: '#fff', letterSpacing: '0.04em', marginTop: '2.5rem', marginBottom: '1rem' }}>For parents</h2>
        <p style={{ marginBottom: '1rem' }}>
        ...
        <MarkReadButton href="/learn/hockey-development-explained" title="HOW HOCKEY DEVELOPMENT WORKS" />
      </div>
