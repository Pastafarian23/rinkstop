  ...
  return (
    <main style={{ maxWidth: '900px', margin: '0 auto', padding: '2rem 1rem 4rem' }}>
      <nav style={{ fontSize: '0.75rem', color: '#555', marginBottom: '1.5rem' }}>
        ...
        <span style={{ margin: '0 0.4rem' }}>›</span>
        <span style={{ color: '#A0A0A0' }}>Development Pathway</span>
      </nav>
      ...
      <div style={{ color: '#1a1a1a', lineHeight: 1.8, fontSize: '1rem' }}>
        <h2 style={{ fontFamily: '"Bebas Neue", sans-serif', fontSize: '1.5rem', color: '#041E42', letterSpacing: '0.04em', marginTop: '2.5rem', marginBottom: '1rem' }}>The full pathway</h2>
        ...
        <h2 style={{ fontFamily: '"Bebas Neue", sans-serif', fontSize: '1.4rem', color: '#041E42', letterSpacing: '0.04em', marginTop: '2rem', marginBottom: '0.75rem' }}>Level 1: Learn to Play (ages 4-8)</h2>
        <p style={{ marginBottom: '1rem' }}>
        ...
        <h2 style={{ fontFamily: '"Bebas Neue", sans-serif', fontSize: '1.4rem', color: '#041E42', letterSpacing: '0.04em', marginTop: '2rem', marginBottom: '0.75rem' }}>Level 2: House hockey (ages 8-14)</h2>
        <p style={{ marginBottom: '1rem' }}>
        ...
        <h2 style={{ fontFamily: '"Bebas Neue", sans-serif', fontSize: '1.4rem', color: '#041E42', letterSpacing: '0.04em', marginTop: '2rem', marginBottom: '0.75rem' }}>Level 3: Travel hockey (ages 10-18)</h2>
        <p style={{ marginBottom: '1rem' }}>
        ...
        <h2 style={{ fontFamily: '"Bebas Neue", sans-serif', fontSize: '1.4rem', color: '#041E42', letterSpacing: '0.04em', marginTop: '2rem', marginBottom: '0.75rem' }}>Level 4: High school hockey (ages 14-18)</h2>
        <p style={{ marginBottom: '1rem' }}>
        ...
        <h2 style={{ fontFamily: '"Bebas Neue", sans-serif', fontSize: '1.4rem', color: '#041E42', letterSpacing: '0.04em', marginTop: '2rem', marginBottom: '0.75rem' }}>Level 5: Junior hockey (ages 16-20)</h2>
        <p style={{ marginBottom: '1rem' }}>
        ...
        <h2 style={{ fontFamily: '"Bebas Neue", sans-serif', fontSize: '1.4rem', color: '#041E42', letterSpacing: '0.04em', marginTop: '2rem', marginBottom: '0.75rem' }}>Level 6: College hockey (ages 18-22+)</h2>
        <p style={{ marginBottom: '1rem' }}>
        ...
        <h2 style={{ fontFamily: '"Bebas Neue", sans-serif', fontSize: '1.4rem', color: '#041E42', letterSpacing: '0.04em', marginTop: '2rem', marginBottom: '0.75rem' }}>Level 7: Pro hockey (age 20+)</h2>
        <p style={{ marginBottom: '1rem' }}>
        ...
        <h2 style={{ fontFamily: '"Bebas Neue", sans-serif', fontSize: '1.5rem', color: '#041E42', letterSpacing: '0.04em', marginTop: '2.5rem', marginBottom: '1rem' }}>Realistic expectations by level</h2>
        <p style={{ marginBottom: '1rem' }}>
        ...
        <h2 style={{ fontFamily: '"Bebas Neue", sans-serif', fontSize: '1.5rem', color: '#041E42', letterSpacing: '0.04em', marginTop: '2.5rem', marginBottom: '1rem' }}>The right move at every level</h2>
        <p style={{ marginBottom: '1rem' }}>
