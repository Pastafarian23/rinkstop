  ...
  return (
    <main style={{ maxWidth: '900px', margin: '0 auto', padding: '2rem 1rem 4rem' }}>
      <nav style={{ fontSize: '0.75rem', color: 'rgba(255,255,255,0.4)', marginBottom: '1.5rem' }}>
        ...
        <span style={{ margin: '0 0.4rem' }}>›</span>
        <span style={{ color: 'rgba(255,255,255,0.6)' }}>Cost by Age</span>
      </nav>
      ...
      <div style={{ color: 'rgba(255,255,255,0.75)', lineHeight: 1.8, fontSize: '1rem' }}>
        <h2 style={{ fontFamily: '"Bebas Neue", sans-serif', fontSize: '1.5rem', color: '#fff', letterSpacing: '0.04em', marginTop: '2.5rem', marginBottom: '1rem' }}>Use the cost calculator first</h2>
        ...
        <h2 style={{ fontFamily: '"Bebas Neue", sans-serif', fontSize: '1.4rem', color: '#fff', letterSpacing: '0.04em', marginTop: '2rem', marginBottom: '0.75rem' }}>6U (ages 5-6): $400-800 per year</h2>
        <p style={{ marginBottom: '1rem' }}>
        ...
        <h2 style={{ fontFamily: '"Bebas Neue", sans-serif', fontSize: '1.4rem', color: '#fff', letterSpacing: '0.04em', marginTop: '2rem', marginBottom: '0.75rem' }}>8U (ages 7-8): $500-1,200 per year</h2>
        <p style={{ marginBottom: '1rem' }}>
        ...
        <h2 style={{ fontFamily: '"Bebas Neue", sans-serif', fontSize: '1.4rem', color: '#fff', letterSpacing: '0.04em', marginTop: '2rem', marginBottom: '0.75rem' }}>10U (ages 9-10): $1,000-2,500 per year</h2>
        <p style={{ marginBottom: '1rem' }}>
        ...
        <h2 style={{ fontFamily: '"Bebas Neue", sans-serif', fontSize: '1.4rem', color: '#fff', letterSpacing: '0.04em', marginTop: '2rem', marginBottom: '0.75rem' }}>12U (ages 11-12): $1,500-5,000 per year</h2>
        <p style={{ marginBottom: '1rem' }}>
        ...
        <h2 style={{ fontFamily: '"Bebas Neue", sans-serif', fontSize: '1.4rem', color: '#fff', letterSpacing: '0.04em', marginTop: '2rem', marginBottom: '0.75rem' }}>14U (ages 13-14): $2,500-10,000 per year</h2>
        <p style={{ marginBottom: '1rem' }}>
        ...
        <h2 style={{ fontFamily: '"Bebas Neue", sans-serif', fontSize: '1.4rem', color: '#fff', letterSpacing: '0.04em', marginTop: '2rem', marginBottom: '0.75rem' }}>16U (ages 15-16): $5,000-25,000 per year</h2>
        <p style={{ marginBottom: '1rem' }}>
        ...
        <h2 style={{ fontFamily: '"Bebas Neue", sans-serif', fontSize: '1.4rem', color: '#fff', letterSpacing: '0.04em', marginTop: '2rem', marginBottom: '0.75rem' }}>18U (ages 17-18): $5,000-30,000 per year</h2>
        <p style={{ marginBottom: '1rem' }}>
        ...
        <h2 style={{ fontFamily: '"Bebas Neue", sans-serif', fontSize: '1.5rem', color: '#fff', letterSpacing: '0.04em', marginTop: '2.5rem', marginBottom: '1rem' }}>The hidden costs nobody warns you about</h2>
        <p style={{ marginBottom: '1rem' }}>
        ...
        <h2 style={{ fontFamily: '"Bebas Neue", sans-serif', fontSize: '1.5rem', color: '#fff', letterSpacing: '0.04em', marginTop: '2.5rem', marginBottom: '1rem' }}>How to save money without compromising the experience</h2>
        <p style={{ marginBottom: '1rem' }}>
        ...
        <MarkReadButton href="/learn/cost-by-age" title="HOCKEY COST BY AGE" />
      </div>
