  ...
  return (
    <main style={{ maxWidth: '900px', margin: '0 auto', padding: '2rem 1rem 4rem' }}>
      <nav style={{ fontSize: '0.75rem', color: '#555', marginBottom: '1.5rem' }}>
        ...
        <span style={{ margin: '0 0.4rem' }}>›</span>
        <span style={{ color: '#A0A0A0' }}>Skate Fitting</span>
      </nav>
      ...
      <div style={{ color: '#1a1a1a', lineHeight: 1.8, fontSize: '1rem' }}>
        <h2 style={{ fontFamily: '"Bebas Neue", sans-serif', fontSize: '1.5rem', color: '#041E42', letterSpacing: '0.04em', marginTop: '2.5rem', marginBottom: '1rem' }}>Why fit matters more than anything else</h2>
        ...
        <h2 style={{ fontFamily: '"Bebas Neue", sans-serif', fontSize: '1.5rem', color: '#041E42', letterSpacing: '0.04em', marginTop: '2.5rem', marginBottom: '1rem' }}>The sizing system: Bauer, CCM, and the rest</h2>
        <p style={{ marginBottom: '1rem' }}>
        ...
        <h2 style={{ fontFamily: '"Bebas Neue", sans-serif', fontSize: '1.5rem', color: '#041E42', letterSpacing: '0.04em', marginTop: '2.5rem', marginBottom: '1rem' }}>The 5 things to check in the store</h2>
        <p style={{ marginBottom: '1rem' }}>
          When you're standing in the shop with a pair of skates laced up, check these five things before you buy:
        </p>

        <h3 style={{ fontWeight: 700, color: '#041E42', marginTop: '1.5rem', marginBottom: '0.5rem' }}>1. Heel lock</h3>
        <p style={{ marginBottom: '1rem' }}>
        ...
        <h3 style={{ fontWeight: 700, color: '#041E42', marginTop: '1.5rem', marginBottom: '0.5rem' }}>2. Toe room</h3>
        <p style={{ marginBottom: '1rem' }}>
        ...
        <h3 style={{ fontWeight: 700, color: '#041E42', marginTop: '1.5rem', marginBottom: '0.5rem' }}>3. Ankle support</h3>
        <p style={{ marginBottom: '1rem' }}>
        ...
        <h3 style={{ fontWeight: 700, color: '#041E42', marginTop: '1.5rem', marginBottom: '0.5rem' }}>4. The lace test</h3>
        <p style={{ marginBottom: '1rem' }}>
        ...
        <h3 style={{ fontWeight: 700, color: '#041E42', marginTop: '1.5rem', marginBottom: '0.5rem' }}>5. The 10-minute stand</h3>
        <p style={{ marginBottom: '1rem' }}>
        ...
        <h2 style={{ fontFamily: '"Bebas Neue", sans-serif', fontSize: '1.5rem', color: '#041E42', letterSpacing: '0.04em', marginTop: '2.5rem', marginBottom: '1rem' }}>Width: D, EE, and why it matters</h2>
        <p style={{ marginBottom: '1rem' }}>
        ...
        <h2 style={{ fontFamily: '"Bebas Neue", sans-serif', fontSize: '1.5rem', color: '#041E42', letterSpacing: '0.04em', marginTop: '2.5rem', marginBottom: '1rem' }}>Breaking in new skates</h2>
        <p style={{ marginBottom: '1rem' }}>
        ...
        <h2 style={{ fontFamily: '"Bebas Neue", sans-serif', fontSize: '1.5rem', color: '#041E42', letterSpacing: '0.04em', marginTop: '2.5rem', marginBottom: '1rem' }}>What about online shopping?</h2>
        <p style={{ marginBottom: '1rem' }}>
