  ...
  return (
    <main style={{ maxWidth: '800px', margin: '0 auto', padding: '2rem 1rem 4rem' }}>
      <nav style={{ fontSize: '0.75rem', color: 'rgba(255,255,255,0.4)', marginBottom: '1.5rem' }}>
        ...
        <Link href="/policies" style={{ color: 'rgba(255,255,255,0.4)' }}>Policies</Link>
        <span style={{ margin: '0 0.4rem' }}>›</span>
        <span style={{ color: 'rgba(255,255,255,0.6)' }}>Youth Content</span>
      </nav>

      <h1 style={{ fontFamily: '"Bebas Neue", sans-serif', fontSize: 'clamp(2rem, 5vw, 3rem)', color: '#C8102E', letterSpacing: '0.04em', marginBottom: '1rem' }}>
        YOUTH CONTENT POLICY
      </h1>
      <p style={{ marginBottom: '2rem', color: 'rgba(255,255,255,0.55)' }}>Last updated: August 11, 2026</p>
      ...
      <div style={{ color: 'rgba(255,255,255,0.7)', lineHeight: 1.8, fontSize: '1rem' }}>
        ...
        <h2 style={{ fontFamily: '"Bebas Neue", sans-serif', fontSize: '1.5rem', color: '#C8102E', letterSpacing: '0.04em', marginTop: '2.5rem', marginBottom: '1rem' }}>Our compliance frameworks</h2>
        ...
        <h2 style={{ fontFamily: '"Bebas Neue", sans-serif', fontSize: '1.5rem', color: '#C8102E', letterSpacing: '0.04em', marginTop: '2.5rem', marginBottom: '1rem' }}>What youth content we publish</h2>
        ...
        <h2 style={{ fontFamily: '"Bebas Neue", sans-serif', fontSize: '1.5rem', color: '#C8102E', letterSpacing: '0.04em', marginTop: '2.5rem', marginBottom: '1rem' }}>Advertising on youth content</h2>
        <p style={{ marginBottom: '1.5rem' }}>
        ...
        <h2 style={{ fontFamily: '"Bebas Neue", sans-serif', fontSize: '1.5rem', color: '#C8102E', letterSpacing: '0.04em', marginTop: '2.5rem', marginBottom: '1rem' }}>Parent and guardian claims</h2>
        ...
        <h2 style={{ fontFamily: '"Bebas Neue", sans-serif', fontSize: '1.5rem', color: '#C8102E', letterSpacing: '0.04em', marginTop: '2.5rem', marginBottom: '1rem' }}>Removal and takedown</h2>
        <p style={{ marginBottom: '1.5rem' }}>
        ...
        <h2 style={{ fontFamily: '"Bebas Neue", sans-serif', fontSize: '1.5rem', color: '#C8102E', letterSpacing: '0.04em', marginTop: '2.5rem', marginBottom: '1rem' }}>What we don&rsquo;t do</h2>
        <ul style={{ marginLeft: '1.5rem', marginBottom: '1.5rem' }}>
        ...
        <h2 style={{ fontFamily: '"Bebas Neue", sans-serif', fontSize: '1.5rem', color: '#C8102E', letterSpacing: '0.04em', marginTop: '2.5rem', marginBottom: '1rem' }}>Data retention</h2>
        <p style={{ marginBottom: '1.5rem' }}>
        ...
        <h2 style={{ fontFamily: '"Bebas Neue", sans-serif', fontSize: '1.5rem', color: '#C8102E', letterSpacing: '0.04em', marginTop: '2.5rem', marginBottom: '1rem' }}>How this policy fits with the rest of our policies</h2>
        ...
        <h2 style={{ fontFamily: '"Bebas Neue", sans-serif', fontSize: '1.5rem', color: '#C8102E', letterSpacing: '0.04em', marginTop: '2.5rem', marginBottom: '1rem' }}>Contact</h2>
