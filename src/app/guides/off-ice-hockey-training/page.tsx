...
export const metadata: Metadata = {
  title: 'Off-Ice Training for Hockey Players | RinkStop',
  ...
  openGraph: { title: 'Off-Ice Training for Hockey Players | RinkStop', description: 'The best dryland exercises to build explosive power, edge strength, and durability.', type: 'article' },
