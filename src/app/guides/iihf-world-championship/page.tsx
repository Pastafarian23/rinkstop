  ...
  return (
    <div style={{ maxWidth: '860px', margin: '0 auto', padding: '0.75rem 1rem 4rem' }}>
      <nav style={{ fontSize: '0.75rem', color: 'rgba(255,255,255,0.4)', marginBottom: '1rem' }}>
        ...
        <span style={{ margin: '0 0.4rem' }}>›</span>
        <span style={{ color: 'rgba(255,255,255,0.6)' }}>IIHF World Championship</span>
      </nav>
      ...
      <section style={{ marginBottom: '2.5rem' }}>
        ...
        <p style={{ color: 'rgba(255,255,255,0.6)', lineHeight: 1.75, marginBottom: '1rem', fontSize: '0.9375rem' }}>16 teams, 2 weeks, 65 games. The IIHF World Championship is the largest annual hockey tournament in the world and the main international event on the hockey calendar.</p>
      ...
      <section style={{ marginBottom: '2.5rem' }}>
        ...
        <p style={{ color: 'rgba(255,255,255,0.6)', lineHeight: 1.75, marginBottom: '1rem', fontSize: '0.9375rem' }}>The IIHF World Championship is the oldest international hockey tournament. It has been held annually since 1920 (with cancellations during WWII), making it the longest-running hockey event in the world.</p>
      ...
      <section style={{ marginBottom: '2.5rem' }}>
        ...
        <p style={{ color: 'rgba(255,255,255,0.6)', lineHeight: 1.75, marginBottom: '1rem', fontSize: '0.9375rem' }}>The 16 teams are split into two groups of 8. The host nation is automatically seeded; the other 15 teams qualify through IIHF world ranking and qualifier playoffs.</p>
      ...
      <section style={{ marginBottom: '2.5rem' }}>
        ...
        <p style={{ color: 'rgba(255,255,255,0.6)', lineHeight: 1.75, marginBottom: '1rem', fontSize: '0.9375rem' }}>The tournament is the only major international hockey event where the best NHL players regularly compete. The IIHF and NHL have an agreement that releases players for the tournament after NHL playoffs end.</p>
      ...
      <section style={{ marginBottom: '2.5rem' }}>
        ...
        <p style={{ color: 'rgba(255,255,255,0.6)', lineHeight: 1.75, marginBottom: '1rem', fontSize: '0.9375rem' }}>Browse the directory to find national teams and follow the 2026 tournament in Switzerland.</p>
        <div style={{ display: 'grid', gap: '0.5rem' }}>
