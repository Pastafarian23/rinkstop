  ...
  return (
    <div style={{ maxWidth: '860px', margin: '0 auto', padding: '0.75rem 1rem 4rem' }}>
      ...
      <section style={{ marginBottom: '2.5rem' }}>
        ...
        <p style={{ color: 'rgba(255,255,255,0.6)', lineHeight: 1.75, marginBottom: '1rem', fontSize: '0.9375rem' }}>Hockey passes fall into a handful of categories. Most plays involve multiple types:</p>
      ...
      <section style={{ marginBottom: '2.5rem' }}>
        ...
        <p style={{ color: 'rgba(255,255,255,0.6)', lineHeight: 1.75, marginBottom: '1rem', fontSize: '0.9375rem' }}>The fundamentals of a good pass are the same regardless of type. Focus on:</p>
      ...
      <section style={{ marginBottom: '2.5rem' }}>
        ...
        <p style={{ color: 'rgba(255,255,255,0.6)', lineHeight: 1.75, marginBottom: '1rem', fontSize: '0.9375rem' }}>The saucer is the most-used specialty pass. Used to clear sticks, avoid blocked lanes, or feed a forward on a rush. The mechanics:</p>
        ...
        <p style={{ color: 'rgba(255,255,255,0.6)', lineHeight: 1.75, marginBottom: '1rem', fontSize: '0.9375rem' }}>The saucer is most effective on breakouts (clearing the defensive zone over the forechecker stick) and on the power play (feeding the slot player across the seam).</p>
      </section>
      ...
      <section style={{ marginBottom: '2.5rem' }}>
        ...
        <p style={{ color: 'rgba(255,255,255,0.6)', lineHeight: 1.75, marginBottom: '1rem', fontSize: '0.9375rem' }}>The give-and-go is the simplest and most-effective way to beat a defender one-on-one. The mechanics:</p>
        <ol style={{ color: 'rgba(255,255,255,0.6)', lineHeight: 1.7, fontSize: '0.9375rem', paddingLeft: '1.5rem', marginBottom: '1.5rem' }}>
        ...
        <p style={{ color: 'rgba(255,255,255,0.6)', lineHeight: 1.75, marginBottom: '1rem', fontSize: '0.9375rem' }}>The give-and-go works because the defender must commit to either the puck carrier or the support player. The split-second decision is what creates the open lane.</p>
      </section>
      ...
      <section style={{ marginBottom: '2.5rem' }}>
        ...
        <p style={{ color: 'rgba(255,255,255,0.6)', lineHeight: 1.75, marginBottom: '1rem', fontSize: '0.9375rem' }}>The most effective passing drills for practice:</p>
        <div style={{ display: 'grid', gap: '0.75rem' }}>
          {[
