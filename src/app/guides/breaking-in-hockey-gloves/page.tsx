...
export const metadata: Metadata = {
  ...
  openGraph: withDefaultOg({ title: 'Breaking In New Hockey Gloves', description: 'The best methods to break in new hockey gloves without damaging them.', type: 'article' }),
