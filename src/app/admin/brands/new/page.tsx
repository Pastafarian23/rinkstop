  ...
  return (
    <div>
      <div className="page-header" style={{ display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between', gap: '1rem', flexWrap: 'wrap' }}>
        <div>
          <h1><span aria-hidden="true">👕</span> New Brand</h1>
          <p>Add a new equipment or apparel brand.</p>
        </div>
      ...
      <form onSubmit={handleSubmit} className="max-w-xl space-y-4">
        ...
        <button type="submit" className="admin-btn admin-btn-primary">Create Brand</button>
      </form>
    </div>
  );
}