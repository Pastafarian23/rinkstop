 ...
 *
 * Catches unhandled errors in the /pricing segment so the layout
...
export default function PricingError({
  ...
  useEffect(() => {
    console.error('[rinkstop] /pricing error boundary:', error);
  ...
  return (
    ...
    >
      ...
      <div style={{ display: 'flex', gap: 8, flexWrap: 'wrap' }}>
        ...
        <Link
          href="mailto:support@rinkstop.com?subject=Pricing%20inquiry"
          style={{
            padding: '0.55rem 1.1rem',
