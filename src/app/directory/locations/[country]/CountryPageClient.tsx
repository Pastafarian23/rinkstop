...
export default function CountryPageClient({ country, initialData }: Props) {
  ...
  return (
    <div style={{ maxWidth: '1280px', margin: '0 auto', padding: '0 1rem 4rem' }}>
      ...
      <nav style={{ fontSize: '0.75rem', color: 'rgba(255,255,255,0.4)', padding: '1.5rem 0 0', marginBottom: '0' }}>
        ...
        <span style={{ margin: '0 0.4rem' }}>›</span>
        <Link href="/directory/locations" style={{ color: 'rgba(255,255,255,0.4)' }}>Locations</Link>
        <span style={{ margin: '0 0.4rem' }}>›</span>
        <span style={{ color: 'rgba(255,255,255,0.6)' }}>{pageTitle}</span>
      </nav>
