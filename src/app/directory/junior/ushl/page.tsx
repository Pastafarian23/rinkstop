...
export const metadata: Metadata = {
  title: 'USHL Hockey 2026-27 — 17 Teams, NCAA Pipeline',
  description: 'USHL Hockey 2026-27: top junior hockey league in the US with 17 teams. Premier development path for NCAA and professional hockey — only US-based Tier 1 league.',
};
