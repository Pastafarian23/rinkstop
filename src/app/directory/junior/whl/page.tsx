...
export const metadata: Metadata = {
  title: 'WHL Hockey 2026-27 — 22 Teams, NHL Draft Pipeline',
  description: 'WHL Hockey 2026-27: 22 teams across Western Canada and the US Pacific Northwest. Major CHL league and one of the top NHL draft pipelines in the world.',
};
