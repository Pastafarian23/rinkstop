...
export default function PWHLPlayoffsClient({ initialRounds, initialUpdates }: Props) {
  const [rounds, setRounds] = useState<StoredRound[]>(initialRounds);
