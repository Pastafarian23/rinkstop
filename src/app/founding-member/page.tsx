    ...
    try {
      const res = await fetch('/api/founding/upgrade', {
        ...
        body: JSON.stringify({
          ...
          cancelUrl: `${window.location.origin}/founding-member?cancelled=true`,
        }),
      });
      ...
      <div style={{ maxWidth: '1100px', margin: '0 auto' }}>
        <div style={{ textAlign: 'center', marginBottom: '3rem' }}>
          ...
          <p style={{ fontSize: '1.125rem', color: '#888', maxWidth: '600px', margin: '0 auto 1rem' }}>
            Claim your profile, get verified, and lock in your founding member badge forever.
          </p>
          <div style={{ display: 'inline-flex', alignItems: 'center', gap: '0.5rem', background: 'rgba(255,215,0,0.1)', border: '1px solid rgba(255,215,0,0.3)', borderRadius: '6px', padding: '0.5rem 1rem' }}>
            ...
            <span style={{ color: '#888', fontSize: '0.875rem' }}>One-time founding rate — verified for life, badge never expires</span>
          </div>
        </div>
        ...
        <div style={{ maxWidth: '600px', margin: '0 auto', textAlign: 'center' }}>
          ...
          <div style={{ display: 'grid', gap: '0.75rem', textAlign: 'left' }}>
            {[
              { q: 'Is this a one-time payment?', a: 'Yes. Your founding member rate is locked in for life after your first annual payment. No auto-renewal.' },
              { q: 'What do I get as a founding member?', a: 'A verified profile, lifetime founding member badge, and first access to new features as they launch.' },
              { q: 'What payment methods do you accept?', a: 'All major credit and debit cards via Stripe.' },
              { q: 'How long does verification take?', a: "After payment, your profile goes live immediately. You're a verified founding member from day one." },
            ].map(({ q, a }) => (
