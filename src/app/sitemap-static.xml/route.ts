...
const staticUrls: { url: string; changeFreq: 'daily' | 'weekly' | 'monthly' | 'yearly'; priority: number }[] = [
  ...
  { url: `${baseUrl}/guides/ahl`, changeFreq: 'monthly', priority: 0.7 },
  { url: `${baseUrl}/guides/khl`, changeFreq: 'monthly', priority: 0.7 },
  { url: `${baseUrl}/guides/chl`, changeFreq: 'monthly', priority: 0.7 },
  { url: `${baseUrl}/guides/ushl`, changeFreq: 'monthly', priority: 0.7 },
  { url: `${baseUrl}/guides/pwhl`, changeFreq: 'monthly', priority: 0.7 },
  { url: `${baseUrl}/guides/goaltending`, changeFreq: 'monthly', priority: 0.7 },
  { url: `${baseUrl}/guides/skating`, changeFreq: 'monthly', priority: 0.7 },
  { url: `${baseUrl}/guides/shooting`, changeFreq: 'monthly', priority: 0.7 },
  { url: `${baseUrl}/guides/strength-conditioning`, changeFreq: 'monthly', priority: 0.7 },
  { url: `${baseUrl}/guides/stickhandling`, changeFreq: 'monthly', priority: 0.7 },
  { url: `${baseUrl}/guides/passing`, changeFreq: 'monthly', priority: 0.7 },
  { url: `${baseUrl}/guides/defensive-play`, changeFreq: 'monthly', priority: 0.7 },
  { url: `${baseUrl}/guides/officiating`, changeFreq: 'monthly', priority: 0.7 },
  ...
  // WS27 PR6 (2026-09-14): per-brand gear landing pages.
  { url: `${baseUrl}/gear-brands/bauer`, changeFreq: 'monthly', priority: 0.6 },
  { url: `${baseUrl}/gear-brands/ccm`, changeFreq: 'monthly', priority: 0.6 },
  { url: `${baseUrl}/gear-brands/true`, changeFreq: 'monthly', priority: 0.6 },
  { url: `${baseUrl}/gear-brands/warrior`, changeFreq: 'monthly', priority: 0.6 },
  { url: `${baseUrl}/gear-brands/easton`, changeFreq: 'monthly', priority: 0.5 },
  { url: `${baseUrl}/gear-brands/sherwood`, changeFreq: 'monthly', priority: 0.5 },
  { url: `${baseUrl}/gear-brands/brians`, changeFreq: 'monthly', priority: 0.5 },
  { url: `${baseUrl}/gear-brands/tour`, changeFreq: 'monthly', priority: 0.5 },
  // WS28 PR1 (2026-09-14): Structured data export for AI engines
  { url: `${baseUrl}/api/data/dataset`, changeFreq: 'daily', priority: 0.5 },
  { url: `${baseUrl}/api/data/dataset?entity=rinks`, changeFreq: 'daily', priority: 0.5 },
  { url: `${baseUrl}/api/data/dataset?entity=teams`, changeFreq: 'daily', priority: 0.5 },
  { url: `${baseUrl}/api/data/dataset?entity=leagues`, changeFreq: 'daily', priority: 0.5 },
  { url: `${baseUrl}/api/data/dataset?entity=players`, changeFreq: 'daily', priority: 0.5 },
  { url: `${baseUrl}/api/data/dataset?entity=federations`, changeFreq: 'daily', priority: 0.5 },
  { url: `${baseUrl}/api/data/dataset?format=schema`, changeFreq: 'weekly', priority: 0.4 },
