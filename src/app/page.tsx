        ...
        <div className="container">
          <div style={{ textAlign: 'center', maxWidth: '720px', margin: '0 auto 2rem' }}>
            ...
            <p style={{ color: 'rgba(255,255,255,0.65)', fontSize: 'clamp(0.9375rem, 2vw, 1rem)', margin: 0, lineHeight: 1.6 }}>
              Free is free, forever — and it now includes 1 free claim and free identity verification. Verified Identity ($24.99/yr) unlocks the Hockey Passport, payments eligibility, and direct messaging. Identity Plus ($59.99/yr) adds Family Hub and advanced analytics. For organizations: Club Starter ($149/yr, up to 30 players), Club Pro ($399/yr, up to 150), Club Elite ($999/yr, unlimited teams), League (starting $1,999/yr). For businesses: Business Listing ($99/yr) and Business Plus ($299/yr). Federation is custom for enterprise-scale organizations.
            </p>
          </div>
