    ...
    <div className="w-full">
      <div className="flex items-center gap-2">
        ...
        <input
          ...
          autoCapitalize="off"
          autoCorrect="off"
          className="flex-1 bg-black/40 border border-white/20 rounded-lg px-3 py-2 text-white placeholder-white/40 focus:outline-none focus:border-[#FFB81C] focus:bg-black/60 disabled:opacity-50 caret-[#FFB81C]"
