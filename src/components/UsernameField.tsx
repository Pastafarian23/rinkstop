    ...
    <div className="w-full">
      <div className="flex items-center gap-2">
        ...
        <input
          ...
          autoCapitalize="off"
          autoCorrect="off"
          className="flex-1 bg-white/5 border border-white/10 rounded-lg px-3 py-2 text-white placeholder-white/30 focus:outline-none focus:border-[#FFB81C] disabled:opacity-50"
