...
function pickCTAs(category: string | undefined, tags: string[] | undefined, title: string | undefined): CTA[] {
  ...
  if (/ice\s*rink|skating|open\s*skate|public\s*skat|recreation/.test(text)) {
    ctas.push({
      ...
      cta: 'Browse Rinks',
      icon: '🏒',
      highlight: '800+ cities in 50+ countries',
    });
  }
  ...
  if (ctas.length === 0) {
    ctas.push({
      ...
      pitch: '800+ cities in 50+ countries, 900+ rinks, 2,100+ teams, 6,300+ players, 190+ leagues. The world\'s largest hockey directory — searchable by city, state, or country.',
      href: '/directory',
      cta: 'Open Directory',
      icon: '🏒',
    });
