...
export default function TryoutGuideForm({ source, magSource }: Props) {
    ...
    return (
      <div style={{ textAlign: 'center', padding: '0.5rem 0' }}>
        ...
        <p style={{ color: 'rgba(255,255,255,0.85)', fontSize: '0.9rem', margin: '0 0 1rem' }}>
          Tap below to read or print. Use "Save as PDF" in your browser to download.
        </p>
        <Link
          href="/tryout-guide/read"
          style={{
        ...
        <p style={{ color: 'rgba(255,255,255,0.7)', fontSize: '0.8rem', margin: '1rem 0 0' }}>
          Tip: On mobile, tap Share → Print → Save as PDF. On desktop, File → Print → Save as PDF.
        </p>
      </div>
    );
  }
  ...
  return (
    <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '0.75rem' }}>
      ...
      <p style={{ color: 'rgba(255,255,255,0.85)', fontSize: '0.875rem', margin: 0 }}>
        25 pages · 5 chapters · printable PDF · no spam
      </p>
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: '0.5rem', marginTop: '0.5rem' }}>
        ...
        <input
          ...
          placeholder="Kid's age (optional, e.g., 10)"
          maxLength={3}
          style={{
            background: 'rgba(255,255,255,0.95)',
            border: 'none',
