      ...
      {loading && (
        <div style={{
          ...
          {Array.from({ length: 9 }).map((_, i) => (
            <div key={i} style={{ background: 'var(--s2)', border: '1px solid var(--border)', borderRadius: '6px', padding: '1.5rem', height: '180px' }}>
              <div className="skeleton" style={{ height: '1rem', width: '40%', marginBottom: '1rem' }} />
              <div className="skeleton" style={{ height: '0.75rem', width: '70%', marginBottom: '0.5rem' }} />
