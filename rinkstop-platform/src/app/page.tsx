              ...
              : teams.length > 0
                ...
                : (
                  <div style={{ gridColumn: '1 / -1', textAlign: 'center', padding: '3rem 1rem' }}>
                    ...
                    <Link href="/admin/teams/new" className="btn btn-red">Add the First Team</Link>
                  </div>
                )
            }
          </div>
        ...
        <section className="section-py" style={{ background: '#111823', borderBottom: '1px solid rgba(255,255,255,0.06)' }}>
          <div className="container">
            <div className="sec-head">
              ...
              <Link href="/blog" className="sec-link">All News →</Link>
            </div>
            <div className="news-grid">
              {posts.map(p => (
                <Link key={p.id} href={`/blog/${p.slug}`} className="card" style={{ textDecoration: 'none' }}>
