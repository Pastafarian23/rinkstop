...
const nextConfig = {
  ...
  async redirects() {
    return [
      ...
      { source: '/directory/teams/ottawa-senators-original', destination: '/directory/teams/ottawa-senators', permanent: true },
      { source: '/directory/teams/quebec-bulldogs', destination: '/directory/teams/quebec-remparts', permanent: true },
      { source: '/directory/teams/philadelphia-quakers', destination: '/directory/teams/philadelphia-flyers', permanent: true },
      { source: '/directory/teams/st-louis-eagles', destination: '/directory/teams/st-louis-blues', permanent: true },
      { source: '/directory/teams/cleveland-barons', destination: '/directory/teams/cleveland-monsters', permanent: true },
      { source: '/directory/teams/kansas-city-scouts', destination: '/directory/teams/kansas-city', permanent: true },
      { source: '/directory/teams/colorado-rockies', destination: '/directory/teams/colorado-avalanche', permanent: true },
      { source: '/directory/teams/detroit-cougars', destination: '/directory/teams/detroit-red-wings', permanent: true },
      { source: '/directory/teams/detroit-falcons', destination: '/directory/teams/detroit-red-wings', permanent: true },
      { source: '/directory/teams/winnipeg-jets-original', destination: '/directory/teams/winnipeg-jets', permanent: true },
      { source: '/directory/teams/arizona-coyotes-historical', destination: '/directory/teams/arizona-coyotes', permanent: true },
      { source: '/directory/teams/quebec-nordiques', destination: '/directory/teams/quebec-remparts', permanent: true },
      { source: '/directory/teams/hartford-whalers', destination: '/directory/teams/hartford-wolf-pack', permanent: true },
      { source: '/directory/teams/edmonton-oil-kings-original', destination: '/directory/teams/edmonton-oilers', permanent: true },
      { source: '/directory/teams/winnipeg-warriors', destination: '/directory/teams/winnipeg-jets', permanent: true },
      { source: '/directory/teams/mississauga-icedogs', destination: '/directory/teams/mississauga-steelheads', permanent: true },
      { source: '/directory/teams/kingston-raiders', destination: '/directory/teams/kingston-frontenacs', permanent: true },
      { source: '/directory/teams/vernon-essos', destination: '/directory/teams/vernon-vipers', permanent: true },
      { source: '/directory/teams/chilliwack-bruins-bchl', destination: '/directory/teams/chilliwack-chiefs', permanent: true },
      { source: '/directory/teams/moose-jaw-canucks', destination: '/directory/teams/moose-jaw-warriors', permanent: true },
      { source: '/directory/teams/vancouver-nats', destination: '/directory/teams/vancouver-canucks', permanent: true },
      { source: '/directory/teams/nanaimo-islanders', destination: '/directory/teams/nanaimo-clippers', permanent: true },
      { source: '/directory/teams/detroit-compuware-ambassadors', destination: '/directory/teams/detroit-red-wings', permanent: true },
      { source: '/directory/teams/guelph-royals', destination: '/directory/teams/guelph', permanent: true },
      { source: '/directory/teams/minnesota-whitecaps-nwhl', destination: '/directory/teams/minnesota-whitecaps', permanent: true },
      { source: '/directory/teams/kamloops-chiefs', destination: '/directory/teams/kamloops-blazers', permanent: true },
      { source: '/directory/teams/detroit-junior-red-wings', destination: '/directory/teams/detroit-red-wings', permanent: true },
      { source: '/directory/teams/calgary-wranglers-whl', destination: '/directory/teams/calgary-wranglers', permanent: true },
      { source: '/directory/teams/lethbridge-broncos', destination: '/directory/teams/lethbridge-hurricanes', permanent: true },
      { source: '/directory/teams/kelowna-wings', destination: '/directory/teams/kelowna-rockets', permanent: true },
      { source: '/directory/teams/detroit-whalers', destination: '/directory/teams/detroit-red-wings', permanent: true },
      { source: '/directory/teams/windsor-compuware-spitfires', destination: '/directory/teams/windsor', permanent: true },
      { source: '/directory/teams/minnesota-whitecaps-phf', destination: '/directory/teams/minnesota-whitecaps', permanent: true },
      { source: '/directory/teams/calgary-buffaloes', destination: '/directory/teams/calgary', permanent: true },
      { source: '/directory/teams/north-bay-centennials', destination: '/directory/teams/north-bay-battalion', permanent: true },
      { source: '/directory/teams/plymouth-whalers', destination: '/directory/teams/plymouth-state-university-panthers', permanent: true },
      { source: '/directory/teams/windsor-compuware-spitfires-2', destination: '/directory/teams/windsor', permanent: true },
      { source: '/directory/teams/calgary-centennials', destination: '/directory/teams/calgary', permanent: true },
      { source: '/directory/teams/brantford-alexanders', destination: '/directory/teams/brantford-bulldogs', permanent: true },
      { source: '/directory/teams/granby-bisons', destination: '/directory/teams/granby-pr-dateurs', permanent: true },
      { source: '/directory/teams/sherbrooke-castors-2nd', destination: '/directory/teams/sherbrooke-phoenix', permanent: true },
      { source: '/directory/teams/penticton-knights', destination: '/directory/teams/penticton-vees-bchl', permanent: true },
      { source: '/directory/teams/langley-blazers', destination: '/directory/teams/langley-rivermen', permanent: true },
      { source: '/directory/teams/kelowna-spartans', destination: '/directory/teams/kelowna-rockets', permanent: true },
      { source: '/directory/teams/edmonton-oil-kings-2nd', destination: '/directory/teams/edmonton-oilers', permanent: true },
      { source: '/directory/teams/mississauga-st-michaels-majors', destination: '/directory/teams/mississauga-steelheads', permanent: true },
      { source: '/directory/teams/guelph-platers', destination: '/directory/teams/guelph', permanent: true },
      { source: '/directory/teams/shawinigan-dynamos', destination: '/directory/teams/shawinigan-cataractes', permanent: true },
      { source: '/directory/teams/penticton-jr-vees', destination: '/directory/teams/penticton-vees-bchl', permanent: true },
      { source: '/directory/teams/winnipeg-monarchs', destination: '/directory/teams/winnipeg-jets', permanent: true },
      { source: '/directory/teams/spokane-flyers-junior', destination: '/directory/teams/spokane-chiefs', permanent: true },
      { source: '/directory/teams/kingston-canadians', destination: '/directory/teams/kingston-frontenacs', permanent: true },
      { source: '/directory/teams/vernon-blades', destination: '/directory/teams/vernon-vipers', permanent: true },
      { source: '/directory/teams/vancouver-villas', destination: '/directory/teams/vancouver-canucks', permanent: true },
      { source: '/directory/teams/kamloops-rockets-bchl', destination: '/directory/teams/kamloops-blazers', permanent: true },
      { source: '/directory/teams/owen-sound-platers', destination: '/directory/teams/owen-sound-attack', permanent: true },
      { source: '/directory/teams/vernon-canadians-1st', destination: '/directory/teams/vernon-vipers', permanent: true },
      { source: '/directory/teams/vancouver-centennials', destination: '/directory/teams/vancouver-canucks', permanent: true },
      { source: '/directory/teams/abbotsford-falcons', destination: '/directory/teams/abbotsford-canucks', permanent: true },
      { source: '/directory/teams/shawinigan-bruins', destination: '/directory/teams/shawinigan-cataractes', permanent: true },
      { source: '/directory/teams/sherbrooke-castors-1st', destination: '/directory/teams/sherbrooke-phoenix', permanent: true },
      { source: '/directory/teams/moncton-alpines', destination: '/directory/teams/moncton', permanent: true },
      { source: '/directory/teams/penticton-broncos', destination: '/directory/teams/penticton-vees-bchl', permanent: true },
      { source: '/directory/teams/shuswap-blazers', destination: '/directory/teams/salmon-arm-silverbacks', permanent: true },
      { source: '/directory/teams/aik-shl-historical', destination: '/directory/teams/aik', permanent: true },
      { source: '/directory/teams/hammarby-if-shl', destination: '/directory/teams/hammarby-if', permanent: true },
      { source: '/directory/teams/malmo-if', destination: '/directory/teams/malmo-redhawks-shl', permanent: true },
      { source: '/directory/teams/karlskrona-hk', destination: '/directory/teams/karlskrona', permanent: true },
      { source: '/directory/teams/mora-ik', destination: '/directory/teams/mora', permanent: true },
      { source: '/directory/teams/drummondville-rangers', destination: '/directory/teams/drummondville-voltigeurs', permanent: true },
      { source: '/directory/teams/sherbrooke-faucons', destination: '/directory/teams/sherbrooke-phoenix', permanent: true },
      { source: '/directory/teams/timra-ik', destination: '/directory/teams/timrå', permanent: true },
      { source: '/directory/teams/vernon-canadians-2nd', destination: '/directory/teams/vernon-vipers', permanent: true },
      { source: '/directory/teams/salmon-arm-tigers', destination: '/directory/teams/salmon-arm-silverbacks', permanent: true },
      { source: '/directory/teams/kelowna-buckaroos', destination: '/directory/teams/kelowna-rockets', permanent: true },
      { source: '/directory/teams/langley-thunder', destination: '/directory/teams/langley-rivermen', permanent: true },
      { source: '/directory/teams/vernon-vikings', destination: '/directory/teams/vernon-vipers', permanent: true },
      { source: '/directory/teams/chilliwack-colts', destination: '/directory/teams/chilliwack-chiefs', permanent: true },
      { source: '/directory/teams/langley-hornets', destination: '/directory/teams/langley-rivermen', permanent: true },
      { source: '/directory/teams/calgary-cowboys-ajhl', destination: '/directory/teams/calgary', permanent: true },
      { source: '/directory/teams/red-deer-rustlers', destination: '/directory/teams/red-deer-rebels', permanent: true },
      { source: '/directory/teams/sherwood-park-crusaders-ajhl', destination: '/directory/teams/sherwood-park-crusaders', permanent: true },
      { source: '/directory/teams/blackfalds-bulldogs-ajhl', destination: '/directory/teams/blackfalds-bulldogs', permanent: true },
      { source: '/directory/teams/calgary-buffaloes-ajhl', destination: '/directory/teams/calgary', permanent: true },
      { source: '/directory/teams/calgary-mustangs', destination: '/directory/teams/calgary', permanent: true },
      { source: '/directory/teams/austin-mavericks', destination: '/directory/teams/austin-bruins', permanent: true },
      { source: '/directory/teams/mount-royal-cougars', destination: '/directory/teams/mount-royal', permanent: true },
      { source: '/directory/teams/lethbridge-sugar-kings', destination: '/directory/teams/lethbridge-hurricanes', permanent: true },
      { source: '/directory/teams/calgary-chinooks', destination: '/directory/teams/calgary', permanent: true },
      { source: '/directory/teams/calgary-spurs', destination: '/directory/teams/calgary', permanent: true },
      { source: '/directory/teams/milwaukee-admirals-ushl', destination: '/directory/teams/milwaukee-admirals', permanent: true },
      { source: '/directory/teams/north-iowa-huskies', destination: '/directory/teams/north-iowa-bulls', permanent: true },
      { source: '/directory/teams/ohio-junior-blue-jackets', destination: '/directory/teams/ohio-state-university', permanent: true },
      { source: '/directory/teams/sault-ste-marie-canadians', destination: '/directory/teams/sault-ste-marie-greyhounds', permanent: true },
      { source: '/directory/teams/sault-ste-marie-greyhounds-ushl', destination: '/directory/teams/sault-ste-marie-greyhounds', permanent: true },
      { source: '/directory/teams/st-louis-heartland-eagles', destination: '/directory/teams/st-louis-blues', permanent: true },
      { source: '/directory/teams/brooks-bandits-ajhl', destination: '/directory/teams/brooks-bandits', permanent: true },
      { source: '/directory/teams/topeka-scarecrows-h2', destination: '/directory/teams/topeka-scarecrows', permanent: true },
      { source: '/directory/teams/waterloo-black-hawks-original', destination: '/directory/teams/waterloo', permanent: true },
      { source: '/directory/teams/spruce-grove-mets', destination: '/directory/teams/spruce-grove-saints', permanent: true },
      { source: '/directory/teams/spruce-grove-saints-ajhl', destination: '/directory/teams/spruce-grove-saints', permanent: true },
      { source: '/directory/teams/lethbridge-longhorns', destination: '/directory/teams/lethbridge-hurricanes', permanent: true },
      { source: '/directory/teams/okotoks-oilers-ajhl', destination: '/directory/teams/okotoks-oilers', permanent: true },
      { source: '/directory/teams/chicago-warriors', destination: '/directory/teams/chicago-blackhawks', permanent: true },
      { source: '/directory/teams/dubuque-fighting-saints-original', destination: '/directory/teams/dubuque-fighting-saints', permanent: true },
      { source: '/directory/teams/grand-rapids-blades', destination: '/directory/teams/grand-rapids-griffins', permanent: true },
      { source: '/directory/teams/grand-rapids-bruins', destination: '/directory/teams/grand-rapids-griffins', permanent: true },
      { source: '/directory/teams/khimik-voskresensk', destination: '/directory/teams/khimik', permanent: true },
      { source: '/directory/teams/winnipeg-jets-whl', destination: '/directory/teams/winnipeg-jets', permanent: true },
      { source: '/directory/teams/belleville-bulls', destination: '/directory/teams/belleville-senators', permanent: true },
      { source: '/directory/teams/jokerit-helsinki', destination: '/directory/teams/jokerit', permanent: true },
      { source: '/directory/teams/montreal-pwhl', destination: '/directory/teams/montreal-victo', permanent: true },
      { source: '/directory/teams/newfoundland-growlers', destination: '/directory/teams/newfoundland', permanent: true },
      { source: '/directory/teams/montreal-victoire', destination: '/directory/teams/montreal-victo', permanent: true },
      { source: '/directory/teams/chicoutimi-saguenees', destination: '/directory/teams/chicoutimi-saguenéens', permanent: true },
      { source: '/directory/teams/uhl-legion', destination: '/directory/teams/legion', permanent: true },
      { source: '/directory/teams/uhl-bsfk', destination: '/directory/teams/bsfk', permanent: true },
      { source: '/directory/teams/superleague-uk-donbass', destination: '/directory/teams/donbass', permanent: true },
      { source: '/directory/teams/superleague-uk-druzhkovka', destination: '/directory/teams/druzhkovka', permanent: true },
      { source: '/directory/teams/superleague-uk-kramatorsk', destination: '/directory/teams/kramatorsk', permanent: true },
      { source: '/directory/teams/rimouski-oceanic', destination: '/directory/teams/rimouski-oc-anic', permanent: true },
      { source: '/directory/teams/bars-kazan-u18', destination: '/directory/teams/bars', permanent: true },
      { source: '/directory/teams/loko-junior', destination: '/directory/teams/loko', permanent: true },
      { source: '/directory/teams/slovakia-u18', destination: '/directory/teams/slovakia', permanent: true },
      { source: '/directory/teams/russia-u18', destination: '/directory/teams/russia', permanent: true },
      ...
      { source: '/directory/teams/new-zealand-u18-w', destination: '/directory/teams/new-zealand', permanent: true },
      { source: '/directory/teams/calgary-inferno-cwhl', destination: '/directory/teams/calgary', permanent: true },
      { source: '/directory/teams/mississauga-chiefs-cwhl', destination: '/directory/teams/mississauga-steelheads', permanent: true },
      { source: '/directory/teams/south-africa-u18-w', destination: '/directory/teams/south-africa', permanent: true },
      { source: '/directory/teams/turkmenistan-u18', destination: '/directory/teams/turkmenistan', permanent: true },
      { source: '/directory/teams/thailand-u18', destination: '/directory/teams/thailand', permanent: true },
      { source: '/directory/teams/great-britain-u18', destination: '/directory/teams/great-britain', permanent: true },
      ...
      { source: '/directory/teams/vhlb-hc-chelny', destination: '/directory/teams/vhl-chelny', permanent: true },
      { source: '/directory/teams/belarus-u18', destination: '/directory/teams/belarus', permanent: true },
      { source: '/directory/teams/chicoutimi-saguen-es', destination: '/directory/teams/chicoutimi-saguenéens', permanent: true },
      { source: '/directory/teams/france-u18', destination: '/directory/teams/france', permanent: true },
      { source: '/directory/teams/usa-u18', destination: '/directory/teams/usa', permanent: true },
      { source: '/directory/teams/ukraine-u18', destination: '/directory/teams/ukraine', permanent: true },
      { source: '/directory/teams/medvescak-zagreb', destination: '/directory/teams/ihl-slovenia-zagreb', permanent: true },
